...
class BookingReminderAutomationService
{
    ...
    public function generate(array $options = []): array
    {
        ...
        foreach ($campaigns as $campaign) {
            $runs[] = $this->generateForCampaign($campaign, $hoursBefore, $runSource, $options);
        }
    ...
    private function generateForCampaign(
        ...
        return DB::transaction(function () use ($campaign, $hoursBefore, $runSource, $options) {
            ...
            foreach ($appointments as $appointment) {
                ...
                $template = $campaign->template
                    ?? $this->templateService->resolveForTrigger(
                        MarketingTriggerType::BOOKING_REMINDER,
                        $campaign->channel,
                ...
                MarketingMessage::query()->create([
                    ...
                    'purpose' => MarketingMessagePurpose::BOOKING_REMINDER,
    ...
    private function alreadyQueued(string $appointmentId): bool
    {
        return MarketingMessage::query()
            ...
            ->where('purpose', MarketingMessagePurpose::BOOKING_REMINDER)
            ->whereIn('status', [
