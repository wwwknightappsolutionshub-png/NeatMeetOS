...
export default function CrmJoinQrSettingsPage() {
  ...
  return (
    <AdminSettingsShell title="CRM join QR">
        ...
        <div className="space-y-4">
          <Card title="How it works">
            <p className="text-sm text-zinc-600">
              Guests scan this QR to open a short form (name + WhatsApp required). Submissions land
              in your Clients CRM. Multi-location salons can print one QR per location.
            </p>
          ...
          {!multiLocation ? (
            ...
            <>
              <Card title="Tenant CRM join QR (all locations)">
